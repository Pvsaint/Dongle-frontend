...
export default function VerificationStatus({
  ...
  const statusConfig = {
    ...
    PENDING: {
      ...
      description:
        "The verification request is currently being reviewed by the community.",
    ...
    VERIFIED: {
      ...
      title: "Verified",
      description:
        "This project has been verified and is considered trustworthy.",
  ...
  return (
    <div className="w-full max-w-lg mx-auto space-y-6 animate-fade-in">
      ...
      {projectId && (
        <Card
          className={`transition-all duration-300 border-2 ${config.color}`}
          padding="lg"
        >
